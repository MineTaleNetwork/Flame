...
public class MessageCommand extends Command {
    ...
    public MessageCommand() {
        ...
        setDefaultExecutor((sender, context) -> sender.sendMessage(CommandUtil.getUsage(getName(), "player", "message")));
        ...
        }, ArgumentType.Word("player"), ArgumentType.StringArray("message"));
    }
