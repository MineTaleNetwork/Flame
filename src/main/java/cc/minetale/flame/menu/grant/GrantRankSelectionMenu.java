...
//            NamedTextColor color = rank.getRankColor();
//
...
//                                            Component.text()
//                                                    .append(
//                                                            MC.component("Click to grant ", NamedTextColor.GRAY),
//                                                            MC.component(rank.getId(), color),
//                                                            MC.component(" to ", NamedTextColor.GRAY),
//                                                            MC.fixItalics(this.profile.getColoredName())
//                                                    ).build(),
//                                            MC.SEPARATOR_50
//                                    )
//                            ),
...
//                                .append(
//                                        MC.component("< ", NamedTextColor.DARK_GRAY, TextDecoration.BOLD),
//                                        MC.component("Previous Page", NamedTextColor.GRAY)
//                                ).build()),
//                event -> {
...
//                        .withDisplayName(Component.text()
//                                .append(
//                                        MC.component("Next Page", NamedTextColor.GRAY),
//                                        MC.component(" >", NamedTextColor.DARK_GRAY, TextDecoration.BOLD)
//                                ).build()),
//                event -> {
